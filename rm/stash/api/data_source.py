...
from typing import Any, Iterator, Optional, Dict, Protocol, TypeVar
...
TEntity = TypeVar('TEntity', bound=DataEntity)
...
class DataSource(ABC):
    ...
    @abstractmethod
    def fetch(self, **kwargs) -> Iterator[DataEntity]:
        """
        Fetch data from the source.
        
        Returns:
            Iterator over DataEntity objects
        """
        pass
...
class StreamingDataSource(DataSource):
    ...
    @abstractmethod
    def fetch_stream(self, chunk_size: int = 1000, **kwargs) -> Iterator[list[DataEntity]]:
        """
        ...
        Returns:
            Iterator over lists of DataEntity objects (chunks)
        """
        pass
...
class BatchDataSource(DataSource):
    ...
    @abstractmethod
    def fetch_batch(self, batch_size: int = 100, **kwargs) -> Iterator[list[DataEntity]]:
        """
        ...
        Returns:
            Iterator over batches of DataEntity objects
        """
        pass
