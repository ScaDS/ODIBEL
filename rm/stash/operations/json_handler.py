...
try:
    from pyodibel.api.backend import FormatHandler, BackendType
    _BACKEND_AVAILABLE = True
except ImportError:
    # Create a dummy base class if backend module is not available
    class FormatHandler:
        pass
    BackendType = None
...
if _BACKEND_AVAILABLE:
    ...
    # Dummy classes when backend is not available
    class SparkJSONFormatHandler:
        pass
    class PandasJSONFormatHandler:
        pass
